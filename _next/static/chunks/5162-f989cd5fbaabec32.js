      ...
      let w = [
        {
          ...
          slug: "https://t.me/blockDAGnetworkOfficial",
          width: 32,
          height: 32,
        },
        {
          ...
          slug: "https://twitter.com/blockdagnetwork",
          width: 33,
          height: 30,
        },
        {
        ...
        return (0, l.jsxs)("form", {
          ...
          onSubmit: (e) => {
            if (
              ...
              j.Z.error("Fill the required fields!"), r(!1);
              return;
            }
            if (!N.HN.test(t.email)) {
              a((e) => [...e, "email"]),
                j.Z.error("Email is not valid format!"),
                r(!1);
              return;
            }
            let l = {
            ...
            Z.Z.post("".concat(k.XI, "/leads/createLead"), l, k.ob)
              .then((e) => {
                201 == e.status
                  ...
                  : (j.Z.error("Something went wrong!"), r(!1));
              })
              .catch((e) => {
                var t, s, l, i;
          ...
          O(() => {
            if ("/" == G) {
              ...
              if (
                (B.current && (e = B),
                S.current && (e = S),
                E && N && e && e.current && (null == C ? void 0 : C.width))
              ) {
                let t, s;
        ...
        return (0, l.jsx)(c.Z, {
          ...
          children: (0, l.jsxs)(i.Z, {
            ...
            children: [
              ...
              (0, l.jsxs)(a.default, {
                className: (0, m.Z)(n().desc, "font-bold"),
                size: "xl",
                children: [
