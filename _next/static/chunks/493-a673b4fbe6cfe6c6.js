  ...
  [493],
  {
    5540: function (e, t, i) {
      ...
      function d(e) {
        let t,
          i,
          { swiper: a, extendParams: l, on: o } = e;
        l({
          a11y: {
            enabled: !0,
        ...
        function b(e) {
          ...
          if (
            ...
            e.target.matches(n(a.params.pagination.bulletClass))
          ) {
            if (a.navigation && a.navigation.prevEl && a.navigation.nextEl) {
              let e = (0, r.m)(a.navigation.prevEl);
              (0, r.m)(a.navigation.nextEl).includes(i) &&
                ((a.isEnd && !a.params.loop) || a.slideNext(),
                a.isEnd ? c(t.lastSlideMessage) : c(t.nextSlideMessage)),
                e.includes(i) &&
            ...
            a.pagination &&
              i.matches(n(a.params.pagination.bulletClass)) &&
              i.click();
          }
        }
        function y() {
        ...
        let E = (e, t, i) => {
                ...
                requestAnimationFrame(() => {
                  t ||
                    (a.params.loop
                      ...
                      : a.slideTo(a.slides.indexOf(s), 0),
                    (t = !1));
                })));
          },
          P = () => {
            ...
            e.itemRoleDescriptionMessage &&
              ...
              e.slideRole && f(a.slides, e.slideRole);
            let t = a.slides.length;
            e.slideLabelMessage &&
              a.slides.forEach((i, s) => {
                let r = a.params.loop
          ...
          L = () => {
            ...
            !(function (e, t) {
              ...
              P();
            let { nextEl: o, prevEl: p } = a.navigation ? a.navigation : {};
            (o = (0, r.m)(o)),
              (p = (0, r.m)(p)),
              o && o.forEach((t) => E(t, l, e.nextSlideMessage)),
              p && p.forEach((t) => E(t, l, e.prevSlideMessage)),
              S() &&
                (0, r.m)(a.pagination.el).forEach((e) => {
                  e.addEventListener("keydown", b);
                }),
              (0, s.g)().addEventListener("visibilitychange", C),
              a.el.addEventListener("focus", M, !0),
              a.el.addEventListener("focus", M, !0),
              a.el.addEventListener("pointerdown", T, !0),
              a.el.addEventListener("pointerup", x, !0);
          };
        o("beforeInit", () => {
          (d = (0, r.c)("span", a.params.a11y.notificationClass)).setAttribute(
            "aria-live",
            "assertive"
          ),
          ...
          o("fromEdge toEdge afterInit lock unlock", () => {
            a.params.a11y.enabled &&
              (function () {
                ...
                t && (a.isBeginning ? (v(t), h(t)) : (w(t), u(t))),
                  e && (a.isEnd ? (v(e), h(e)) : (w(e), u(e)));
              })();
          }),
          o("paginationUpdate", () => {
            a.params.a11y.enabled &&
                ...
                y() &&
                  a.pagination.bullets.forEach((t) => {
                    a.params.pagination.clickable &&
                      ...
                      t.matches(n(a.params.pagination.bulletActiveClass))
            ...
            a.params.a11y.enabled &&
              (function () {
                ...
                (e = (0, r.m)(e)),
                  ...
                  a.el &&
                    "string" != typeof a.el &&
                    (a.el.removeEventListener("focus", M, !0),
                    a.el.removeEventListener("pointerdown", T, !0),
                    a.el.removeEventListener("pointerup", x, !0));
              })();
          });
      }
      function p(e) {
        ...
        f("init", () => {
          u.params.autoplay.enabled && (A(), _(), x());
        }),
          f("destroy", () => {
            I(), z(), u.autoplay.running && C();
          }),
          ...
          (function (e) {
            ...
            setTranslate: () => {
              ...
              for (let e = 0, t = s.length; e < t; e += 1) {
                ...
                let E = `translate3d(${y}px,${b}px,${v}px)  rotateX(${h(
                  g
                )}deg) rotateY(${h(m)}deg) scale(${S})`;
                if (
                  (((function (e, t) {
                    let i = (0, r.g)(t);
                    return (
                  ...
                  e || (e = c("coverflow", t, n ? "left" : "top")),
                    i || (i = c("coverflow", t, n ? "right" : "bottom")),
                    e && (e.style.opacity = f > 0 ? f : 0),
                    i && (i.style.opacity = -f > 0 ? -f : 0);
                }
              }
            },
            setTransition: (e) => {
          ...
          update: {
            ...
            updateSlidesProgress: function (e) {
              ...
              for (let e = 0; e < i.length; e += 1) {
                ...
                m &&
                  ...
                  c(n, m, t.slideVisibleClass),
                  c(n, f, t.slideFullyVisibleClass),
                  (n.progress = s ? -d : d),
            ...
            updateSlidesClasses: function () {
              ...
              e &&
                ...
                r.loop),
                s.forEach((s) => {
                  u(s, s === e, r.slideActiveClass),
                    u(s, s === i, r.slideNextClass),
                    u(s, s === t, r.slidePrevClass);
                }),
