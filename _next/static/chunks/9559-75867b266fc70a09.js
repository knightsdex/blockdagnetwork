(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9559],
  {
    13875: function (e, t, n) {
      Promise.resolve().then(n.t.bind(n, 231, 23)),
        Promise.resolve().then(n.bind(n, 18709)),
        Promise.resolve().then(n.t.bind(n, 5319, 23)),
        Promise.resolve().then(n.t.bind(n, 71490, 23)),
        ...
        Promise.resolve().then(n.t.bind(n, 76695, 23)),
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsx)(l.Z, {
              ...
              title: (0, r.jsx)(r.Fragment, { children: "404" }),
              xldesc: (0, r.jsx)(r.Fragment, {
                children:
    ...
    41296: function (e, t, n) {
      ...
      var r = n(57437),
        ...
        o = n(2265);
      function a(e) {
        let { q: t, a: n, ul: l, index: a, className: c } = e,
          [d, h] = (0, o.useState)(0),
          [u, _] = (0, o.useState)(0),
          f = (0, o.useRef)(null);
        return (
          (0, o.useEffect)(() => {
            f.current && (d == a ? _(f.current.scrollHeight) : _(0));
          }, [d, a, f]),
          (0, r.jsxs)("div", {
            className: ""
              .concat(i().accordion, " ")
            ...
            children: [
              (0, r.jsxs)("h5", {
                ...
                children: [
                  t,
                  d == a
                    ? (0, r.jsx)(s.Z.Minus, { className: i().icon })
                    : (0, r.jsx)(s.Z.Plus, { className: i().icon }),
                ],
              }),
              (0, r.jsxs)("div", {
    ...
    81079: function (e, t, n) {
      ...
      function d(e) {
        let {
          ...
          b = (0, s.useRef)(null),
          { useGSAP: y, activatedGsap: Z } = (0, i.Z)(),
          k = (0, a.Z)(),
          N = (0, c.usePathname)();
        return (
          y(() => {
            if (
              ...
              (null == k ? void 0 : k.width) < 992
                ? ((f = "right" == u ? -200 : "left" == u ? 200 : f),
                  (_ = "top" == u ? 200 : "bottom" == u ? -200 : _))
                : ((_ = "top" == h ? 200 : "bottom" == h ? -200 : _),
              ...
              let n = o.ZP.timeline({
                scrollTrigger: {
                  ...
                  start: "top ".concat(
                    ...
                    (null == k ? void 0 : k.width) < 992 ? C - 15 : C - 10,
                    "%"
                  ),
                  scrub: 1,
                  markers: !1,
              ...
              return (
                ...
                (t =
                  (null == k ? void 0 : k.width) > 1440
                    ? _
                    : (null == k ? void 0 : k.width) < 992
                    ? ((null == k ? void 0 : k.width) / 500) * _
                    : ((null == k ? void 0 : k.width) / 1440) * _),
                n
                  .from(b.current, {
                    translateY: t,
                    translateX: e,
          ...
          (0, r.jsx)(n, { ...L, ref: b, className: (0, l.Z)(d), children: t })
        );
      }
    },
    70499: function (e, t, n) {
      ...
      function _(e) {
        let {
          ...
          V = (0, a.useRef)(null),
          F = (0, h.Z)(),
          { useGSAP: B, activatedGsap: H } = (0, c.Z)(),
          W = (0, u.usePathname)();
        return (
          B(() => {
            if ("/" == W) {
              ...
              if (
                (P.current && (e = P),
                V.current && (e = V),
                H && b && e && e.current && (null == F ? void 0 : F.width))
              ) {
                let t, n;
                (null == F ? void 0 : F.width) < 992
                  ? ((g = "right" == p ? -200 : "left" == p ? 200 : g),
                    (x = "top" == p ? 200 : "bottom" == p ? -200 : x))
                  : ((x = "top" == m ? 200 : "bottom" == m ? -200 : x),
                    (g = "right" == m ? -200 : "left" == m ? 200 : g));
                let r = d.ZP.timeline({
                  scrollTrigger: {
                    trigger: e.current,
                    start: "top ".concat(
                      (null == F ? void 0 : F.width) < 992 ? y - 10 : y,
                      "%"
                    ),
                    end: "top ".concat(
                ...
                return (
                  ...
                  (n =
                    (null == F ? void 0 : F.width) > 1440
                      ? x
                      : (null == F ? void 0 : F.width) < 992
                      ? ((null == F ? void 0 : F.width) / 500) * x
                      : ((null == F ? void 0 : F.width) / 1440) * x),
                  r
                    .from(e.current, {
                      translateY: n,
                      translateX: t,
            ...
            children: t
              ? _ && "_blank" == _
                ? (0, r.jsxs)(s.default, {
                    ...
                    prefetch: !1,
                    onClick: f,
                    className: (0, o.Z)(i().button, n, i()[k]),
                    children: [l, (0, r.jsx)("span", { className: i().wrap })],
                  })
                : (0, r.jsxs)(s.default, {
                    ref: V,
                    href: t,
      ...
      function f(e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
                    ...
                    children: [
                      (0, r.jsx)("li", {
                        children: (0, r.jsx)(_.default, {
                          href: "/",
                          children: (0, r.jsx)(o.default, { children: "Home" }),
                        }),
                      }),
                      w &&
                        w.map((e, t) =>
                      ...
                      (0, r.jsx)("li", {
                        children: (0, r.jsx)(o.default, { children: n }),
                      }),
                    ],
                  }),
                }),
            ...
            (0, r.jsx)(i.Z, {
              className: (0, h.Z)(d().hero, C),
              children: (0, r.jsxs)(l.Z, {
                className: (0, h.Z)(d().container, L),
                children: [
                  (0, r.jsxs)("div", {
                    className: (0, h.Z)(d().content, b),
                    children: [
                      (0, r.jsxs)("div", {
                        className: (0, h.Z)(d().texts, y),
                        children: [
                          g &&
                            (0, r.jsx)(u.default, {
                              className: Z,
                          ...
                          (0, r.jsx)(a.default, {
                            component: v ? "h2" : "h1",
                            className: (0, h.Z)(d().title, k),
                            children: n,
                          }),
                          f &&
                            (0, r.jsx)(o.default, {
                              className: (0, h.Z)(d().bigdesc, N),
                              size: "xl",
                              children: f,
                            }),
                          " ",
                          c &&
                            (0, r.jsx)(o.default, {
                              className: (0, h.Z)(d().bigdesc, M),
                              size: "lg",
                              children: c,
                            }),
                          m &&
                            (0, r.jsx)(o.default, {
                              className: (0, h.Z)(d().desc, P),
                              children: m,
                            }),
                        ],
                      }),
                      ...
                      x &&
                        (0, r.jsx)("div", {
                          className: (0, h.Z)(d().btns, V),
                          children: x,
                        }),
                    ],
                  }),
                  (0, r.jsx)("div", {
                    className: (0, h.Z)(d().imgWrapper, t.wrapperClass),
                    children: (0, r.jsx)(s.default, {
                      hero: !v,
                      priority: !v,
                      className: (0, h.Z)(d().img, t.className),
                      src: t.src,
                      alt: (null == t ? void 0 : t.alt) || "BlockDAG",
                      width: t.width || 568,
                      height: t.height || 590,
                    }),
                  }),
      ...
      let o = (0, n(2265).forwardRef)((e, t) => {
        ...
        return (0, r.jsx)(r.Fragment, {
          children: (0, r.jsx)("section", {
            ref: t,
            className: (0, s.Z)(i().section, i()[o], l),
            ...a,
            children: n,
          }),
        });
    ...
    71490: function (e) {
      e.exports = {
        policies: "style_policies__xYmMB",
        content: "style_content__bcAps",
      };
    },
    12900: function (e) {
      e.exports = {
    ...
    76695: function (e) {
      e.exports = {
        breadcrumb: "style_breadcrumb__HErlS",
        bannerHero: "style_bannerHero__vAt7R",
        container: "style_container__UsdGG",
        content: "style_content__2dOvL",
        texts: "style_texts__nRZ4h",
        title: "style_title__Wy0Ot",
        bigdesc: "style_bigdesc__lKEgA",
        desc: "style_desc__laUNb",
        btns: "style_btns__4Bk7H",
        circleWrapper: "style_circleWrapper__fGiQn",
        img: "style_img__sZEII",
      };
    },
    60231: function (e) {
      e.exports = {
