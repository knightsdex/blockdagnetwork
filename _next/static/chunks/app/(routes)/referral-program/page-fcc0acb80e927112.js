(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [5203],
  {
    48494: function (t, e, n) {
      Promise.resolve().then(n.bind(n, 41296)),
        Promise.resolve().then(n.bind(n, 70499)),
        Promise.resolve().then(n.t.bind(n, 93155, 23)),
        Promise.resolve().then(n.t.bind(n, 58538, 23)),
        Promise.resolve().then(n.t.bind(n, 74146, 23)),
        Promise.resolve().then(n.t.bind(n, 8408, 23)),
        Promise.resolve().then(n.t.bind(n, 11552, 23)),
        Promise.resolve().then(n.bind(n, 47984)),
        Promise.resolve().then(n.t.bind(n, 14629, 23)),
        Promise.resolve().then(n.t.bind(n, 70210, 23)),
        Promise.resolve().then(n.t.bind(n, 42527, 23)),
    ...
    41296: function (t, e, n) {
      ...
      var r = n(57437),
        ...
        o = n(2265);
      function a(t) {
        let { q: e, a: n, ul: l, index: a, className: _ } = t,
          [d, u] = (0, o.useState)(0),
          [c, h] = (0, o.useState)(0),
          f = (0, o.useRef)(null);
        return (
          (0, o.useEffect)(() => {
            f.current && (d == a ? h(f.current.scrollHeight) : h(0));
          }, [d, a, f]),
          (0, r.jsxs)("div", {
            className: ""
              .concat(s().accordion, " ")
            ...
            children: [
              (0, r.jsxs)("h5", {
                ...
                children: [
                  e,
                  d == a
                    ? (0, r.jsx)(i.Z.Minus, { className: s().icon })
                    : (0, r.jsx)(i.Z.Plus, { className: s().icon }),
                ],
              }),
              (0, r.jsxs)("div", {
                            ...
                            o.Fragment,
                            {
                              children: (function (t) {
                                ...
                                let n = /([^\s]+)-\((https?:\/\/[^\s)]+)\)/g,
                                  ...
                                  l = 0;
                                for (; null !== (e = n.exec(t)); )
                                  e.index > l && i.push(t.slice(l, e.index)),
                                    i.push(
                                      (0, r.jsx)(
                                        "a",
                                        {
    ...
    70499: function (t, e, n) {
      ...
      function h(t) {
        let {
          ...
          V = (0, a.useRef)(null),
          B = (0, u.Z)(),
          { useGSAP: E, activatedGsap: F } = (0, _.Z)(),
          I = (0, c.usePathname)();
        return (
          E(() => {
            if ("/" == I) {
                ...
                return (
                  ...
                  (n =
                    (null == B ? void 0 : B.width) > 1440
                      ? w
                      : (null == B ? void 0 : B.width) < 992
                      ? ((null == B ? void 0 : B.width) / 500) * w
                      : ((null == B ? void 0 : B.width) / 1440) * w),
                  r
                    .from(t.current, {
                      translateY: n,
                      translateX: e,
            ...
            children: e
              ? h && "_blank" == h
                ? (0, r.jsxs)(i.default, {
                    ...
                    prefetch: !1,
                    onClick: f,
                    className: (0, o.Z)(s().button, n, s()[Z]),
                    children: [l, (0, r.jsx)("span", { className: s().wrap })],
                  })
                : (0, r.jsxs)(i.default, {
                    ref: V,
                    href: e,
    ...
    87580: function (t, e, n) {
      ...
      function h(t) {
        let {
          ...
          N = (0, i.useRef)(null),
          P = (0, _.Z)(),
          { useGSAP: V, activatedGsap: B } = (0, d.Z)(),
          E = (0, c.usePathname)();
        return (
          V(() => {
            if (
              ...
              (null == P ? void 0 : P.width) < 992
                ? ((g = "right" == v ? -200 : "left" == v ? 200 : g),
                  (y = "top" == v ? 200 : "bottom" == v ? -200 : y))
                : ((y = "top" == w ? 200 : "bottom" == w ? -200 : y),
                  (g = "right" == w ? -200 : "left" == w ? 200 : g));
              let n = u.ZP.timeline({
                scrollTrigger: {
                  trigger: N.current,
                  start: "top ".concat(
                    ...
                    (null == P ? void 0 : P.width) < 992 ? M - 15 : M - 10,
                    "%"
                  ),
                  scrub: 1,
                  markers: !1,
    ...
    84395: function (t, e, n) {
      ...
      function c(t) {
        let {
          ...
          k = (0, i.useRef)(null),
          j = (0, a.Z)(),
          { useGSAP: Z, activatedGsap: M } = (0, _.Z)(),
          N = (0, u.usePathname)();
        return (
          Z(() => {
            if (
              ...
              (null == j ? void 0 : j.width) < 992
                ? ((m = "right" == f ? -200 : "left" == f ? 200 : m),
                  (p = "top" == f ? 200 : "bottom" == f ? -200 : p))
                : ((p = "top" == h ? 200 : "bottom" == h ? -200 : p),
                  (m = "right" == h ? -200 : "left" == h ? 200 : m));
              let n = d.ZP.timeline({
                scrollTrigger: {
                  trigger: k.current,
                  start: "top ".concat(
                    (null == j ? void 0 : j.width) < 992 ? C - 10 : C,
                    "%"
                  ),
                  end: "top ".concat(
                    (null == j ? void 0 : j.width) < 992 ? b - 15 : b - 10,
                    "%"
                  ),
                  scrub: 1,
                  markers: !1,
              ...
              return (
                ...
                (e =
                  (null == j ? void 0 : j.width) > 1440
                    ? p
                    : (null == j ? void 0 : j.width) < 992
                    ? ((null == j ? void 0 : j.width) / 500) * p
                    : ((null == j ? void 0 : j.width) / 1440) * p),
                n
                  .from(k.current, {
                    translateY: e,
                    translateX: t,
          ...
          (0, r.jsx)(n, {
            ref: k,
            className: (0, o.Z)(s().subtitle, s()[c], l),
            children: e,
          })
        );
      }
    ...
    42527: function (t) {
      t.exports = {
        downloadManual: "style_downloadManual__c1uP6",
        title: "style_title__3bN4b",
        card: "style_card__RIBNz",
        iconWrapper: "style_iconWrapper__dT5Y1",
        icon: "style_icon__lJQe4",
        content: "style_content__Uf6sg",
        description: "style_description__8QH_8",
        button: "style_button__5cTCG",
      };
    },
    8408: function (t) {
      t.exports = {
        faq: "style_faq__yx9j4",
        title: "style_title__al6lL",
        questions: "style_questions__Draqg",
      };
    },
    70210: function (t) {
      t.exports = {
        howItWorks: "style_howItWorks__la1bX",
        title: "style_title__uKysG",
        steps: "style_steps__c58vB",
        step: "style_step___yA0a",
        icon: "style_icon__aFUdL",
        stepTitle: "style_stepTitle__Eu_wi",
        stepDescription: "style_stepDescription__UvQXX",
        stepNumber: "style_stepNumber__czLRc",
      };
    },
    11552: function (t) {
      t.exports = {
        readyToMine: "style_readyToMine__9pgd8",
        content: "style_content__RPOeO",
        title: "style_title__o3pvh",
        description: "style_description__bBL4X",
        button: "style_button__uSxd9",
        note: "style_note__Uuf3v",
        imageWrapper: "style_imageWrapper__vuXM3",
        image: "style_image__k0TN_",
        float: "style_float__5iYEq",
      };
    },
    74146: function (t) {
      t.exports = {
        whyShare: "style_whyShare__se3Qj",
        title: "style_title__0xHgR",
        features: "style_features__POakD",
        feature: "style_feature__Ww8DV",
        icon: "style_icon__ZVGAO",
        featureTitle: "style_featureTitle__KegAs",
        featureDescription: "style_featureDescription__0YOOB",
      };
    },
    12900: function (t) {
      t.exports = {
    ...
    93155: function (t) {
      t.exports = {
        hero: "style_hero__mYfm4",
        bg: "style_bg__s1Mgq",
        mobileBg: "style_mobileBg__5h1Cy",
        content: "style_content__j1ii5",
        title: "style_title__NJK4s",
        description: "style_description__gT2hU",
        button: "style_button__BA_cw",
      };
    },
    69665: function (t) {
      t.exports = {
  ...
  function (t) {
    t.O(
      0,
      [5073, 9667, 4145, 1899, 947, 922, 9391, 231, 3106, 2971, 7023, 1744],
      function () {
        return t((t.s = 48494));
      }
    ),
