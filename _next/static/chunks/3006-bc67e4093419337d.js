  ...
  [3006],
  {
    13006: function (e, t, n) {
      ...
      var i = n(57437),
        ...
        _ = n(90011);
      function g(e) {
        let { title: t, desc: n, descMobile: l, color: g = "dark" } = e,
          j = (0, m.useRef)(null),
          [v, k] = (0, m.useState)(0),
          Z = (e) => {
            if (j && j.current) {
              var t;
              null === (t = j.current) || void 0 === t || t.swiper.slideTo(e);
            }
          };
        return (0, i.jsx)(r.Z, {
          color: g,
          ...
          children: (0, i.jsxs)(o.Z, {
            ...
            children: [
                  ...
                  (0, i.jsxs)("div", {
                    ...
                    children: [
                      (0, i.jsx)(d.default, {
                        ...
                        direction: "top",
                        color: "light",
                        children: "CRYPTO MINERS",
                      }),
                      (0, i.jsx)(a.default, {
                        animate: !0,
                        direction: "top",
                        className: s().title,
                        children: t || "Meet The Technology Behind",
                      }),
                    ],
                  }),
                  (0, i.jsx)(c.default, {
                    animate: !0,
                    direction: "top",
                    className: (0, h.Z)(s().desc, "font-bold d-md"),
                    size: "xl",
                    children:
                      n ||
                      "BlockDAG Represents a Groundbreaking Shift In Blockchain Technology, \n            — Particularly In The Realm of Mining.",
                  }),
                  (0, i.jsx)(c.default, {
                    animate: !0,
                    direction: "top",
                    className: (0, h.Z)(s().desc, "font-bold d-sm"),
                    size: "xl",
                    children:
                      l ||
                      n ||
              ...
              (0, i.jsx)(w.default, {
                direction: "right",
                className: (0, h.Z)(s().tabs, "d-md"),
                children: _.U.filter((e) => e.isApp || e.isProduct).map(
                  (e, t) =>
                    (0, i.jsx)(
                      "div",
                      {
                        ...
                        className: (0, h.Z)(s().tabItem, v === t && s().active),
                        children: e.title,
                      },
                      t
                    )
                ...
                children: _.U.filter((e) => e.isApp || e.isProduct).map(
                  (e, t) =>
                    (0, i.jsx)(
                      p.o5,
                      {
                        className: s().productSliderSlide,
                        children: (0, i.jsxs)(w.default, {
                          direction: "left",
                          className: s().productSlideWrapper,
                          children: [
                            (0, i.jsx)(p.tq, {
                              className: s().innerSlider,
                              modules: [u.tl, u.W_, u.s5],
                              spaceBetween: 0,
                              slidesPerView: 1,
                              navigation: {
                                prevEl: "#prev-earn",
                              ...
                              children: e.imgs.map((e, t) =>
                                (0, i.jsx)(
                                  p.o5,
                                  {
                                    className: s().innerSliderSlide,
                            ...
                            (0, i.jsxs)("div", {
                              ...
                              children: [
                                (0, i.jsx)(c.default, {
                                  className: s().innerTitle,
                                  size: "lg",
                                  children: e.title,
                                }),
                                " ",
                                (0, i.jsx)(c.default, {
                                  className: s().innerDesc,
                                  children: e.desc,
                                }),
                                (0, i.jsx)(C.default, {
                                  className: "d-sm",
                                  color: "light",
                                  href: "/product/".concat(e.slug),
                                  children: "LEARN MORE",
                                }),
                                (0, i.jsx)(L.default, {
                                  className: (0, h.Z)(s().innerLink, "d-md"),
                                  href: "/product/".concat(e.slug),
                                  children: (0, i.jsx)(x.Z.Arrowdown, {}),
                                }),
                              ],
                            }),
                          ],
    ...
    42625: function (e, t, n) {
      ...
      let o = (0, n(2265).forwardRef)((e, t) => {
        let { children: n, className: l, size: o, classic: d, ...a } = e;
    ...
    43615: function (e, t, n) {
      ...
      function p(e) {
        let {
          ...
          V = (0, a.Z)(),
          b = (0, r.useRef)(null),
          { useGSAP: B, activatedGsap: P } = (0, c.Z)(),
          A = (0, u.usePathname)();
        return (
          B(() => {
            if (
              ...
              let e, t;
              (null == V ? void 0 : V.width) < 992
                ? ((_ = "right" == m ? -200 : "left" == m ? 200 : _),
                  (w = "top" == m ? 200 : "bottom" == m ? -200 : w))
                : ((w = "top" == x ? 200 : "bottom" == x ? -200 : w),
                  (_ = "right" == x ? -200 : "left" == x ? 200 : _));
              let n = h.ZP.timeline({
                scrollTrigger: {
                  trigger: b.current,
                  start: "top ".concat(
                    (null == V ? void 0 : V.width) < 992 ? y - 10 : y,
                    "%"
                  ),
                  end: "top ".concat(
                    (null == V ? void 0 : V.width) < 992 ? N - 15 : N - 10,
                    "%"
                  ),
                  scrub: 1,
                  markers: !1,
              ...
              return (
                (e =
                  (null == V ? void 0 : V.width) > 1440
                    ? _
                    : (null == V ? void 0 : V.width) < 992
                    ? ((null == V ? void 0 : V.width) / 500) * _
                    : ((null == V ? void 0 : V.width) / 1440) * _),
                (t =
                  (null == V ? void 0 : V.width) > 1440
                    ? w
                    : (null == V ? void 0 : V.width) < 992
                    ? ((null == V ? void 0 : V.width) / 500) * w
                    : ((null == V ? void 0 : V.width) / 1440) * w),
                n
                  .from(b.current, {
                    translateY: t,
                    translateX: e,
          ...
          (0, i.jsx)(i.Fragment, {
            children:
              "#" === t
                ? (0, i.jsx)("p", {
                    className: (0, d.Z)(s().customlink, s()[C], l),
                    children: f,
                  })
                : p && "_blank" == p
                ? (0, i.jsx)(o.default, {
    ...
    32913: function (e, t, n) {
      ...
      var i = n(57437),
        ...
        s = n.n(l);
      let o = (0, n(2265).forwardRef)((e, t) => {
        let { children: n, className: l, color: o = "dark", ...d } = e;
        return (0, i.jsx)(i.Fragment, {
    ...
    1668: function (e) {
      e.exports = {
        miners: "style_miners__vM_dL",
        container: "style_container__G5mmA",
        texts: "style_texts__roZwG",
        top: "style_top__ELg6x",
        desc: "style_desc__Ql2r2",
        title: "style_title__8fOTo",
        tabs: "style_tabs__fY9rO",
        tabItem: "style_tabItem__p0Jme",
        active: "style_active__AiU2J",
        productSlider: "style_productSlider__25K_E",
        productSliderSlide: "style_productSliderSlide__3T6EJ",
        productSlideWrapper: "style_productSlideWrapper__9G2PA",
        innerSlider: "style_innerSlider__zOCHN",
        innerSliderSlide: "style_innerSliderSlide__lCg82",
        innerContent: "style_innerContent__AHU0X",
        innerLink: "style_innerLink__57Dfo",
        innerTitle: "style_innerTitle__3EX6k",
      };
    },
    48241: function (e) {
      e.exports = {
